...
call mvn install:install-file -DgroupId=com.alibaba.fastsql -DartifactId=fastsql -Dversion=2.0.0_preview_159 -Dpackaging=jar -Dfile=fastsql-2.0.0_preview_135.jar -DgeneratePom=true
